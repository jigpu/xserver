...
static void
tablet_receive_name(void *data, struct zwp_tablet_v2 *tablet, const char *name)
{
    struct xwl_seat *xwl_seat = data;
...
static void
tablet_receive_id(void *data, struct zwp_tablet_v2 *tablet, uint32_t vid,
                  uint32_t pid)
{
    struct xwl_seat *xwl_seat = data;
    struct xwl_tablet *xwl_tablet;
...
static void
tablet_receive_path(void *data, struct zwp_tablet_v2 *tablet, const char *path)
{
    struct xwl_seat *xwl_seat = data;
    struct xwl_tablet *xwl_tablet;
...
static void
tablet_receive_done(void *data, struct zwp_tablet_v2 *tablet)
{
    struct xwl_seat *xwl_seat = data;
    struct xwl_tablet *xwl_tablet;
...
static void
tablet_receive_removed(void *data, struct zwp_tablet_v2 *tablet)
{
    struct xwl_seat *xwl_seat = data;
...
static struct xwl_tablet_tool*
find_xwl_tablet_tool(struct xwl_seat *xwl_seat, struct zwp_tablet_tool_v2 *tool)
{
    struct xwl_tablet_tool *xwl_tablet_tool;
    xorg_list_for_each_entry(xwl_tablet_tool, &xwl_seat->tablet_tools, link) {
        if (xwl_tablet_tool->tool == tool) {
            return xwl_tablet_tool;
        }
    }
    ErrorF("Unknown xwl_tablet_tool\n");
    return NULL;
}
...
{
    struct xwl_seat *xwl_seat = data;
    struct xwl_tablet_tool *xwl_tablet_tool = find_xwl_tablet_tool(xwl_seat, tool);
...
tablet_seat_add_tablet(void *data, struct zwp_tablet_seat_v2 *tablet_seat, struct zwp_tablet_v2 *tablet)
{
    ...
    zwp_tablet_v2_add_listener(tablet, &tablet_listener, xwl_seat);
}
...
tablet_seat_add_tool(void *data, struct zwp_tablet_seat_v2 *tablet_seat, struct zwp_tablet_tool_v2 *tool)
{
    ...
    zwp_tablet_tool_v2_add_listener(tool, &tablet_tool_listener, xwl_seat);
}
