...
static void
tablet_receive_name(void *data, struct zwp_tablet1 *tablet, const char *name)
{
    struct xwl_seat *xwl_seat = data;
...
static void
tablet_receive_id(void *data, struct zwp_tablet1 *tablet, uint32_t vid,
                  uint32_t pid)
{
    struct xwl_seat *xwl_seat = data;
    struct xwl_tablet *xwl_tablet;
...
static void
tablet_receive_type(void *data, struct zwp_tablet1 *tablet, uint32_t type)
{
    LogMessageVerbSigSafe(X_NOTICE, -1, "xwayland: receiving tablet type %d\n", type);
}

static void
tablet_receive_path(void *data, struct zwp_tablet1 *tablet, const char *path)
{
    struct xwl_seat *xwl_seat = data;
    struct xwl_tablet *xwl_tablet;
...
static void
tablet_receive_done(void *data, struct zwp_tablet1 *tablet)
{
    struct xwl_seat *xwl_seat = data;
    struct xwl_tablet *xwl_tablet;
...
static void
tablet_receive_removed(void *data, struct zwp_tablet1 *tablet)
{
    struct xwl_seat *xwl_seat = data;
...
static void
tablet_tool_receive_type(void *data, struct zwp_tablet_tool1 *tool,
                         uint32_t type)
{
    struct xwl_seat *xwl_seat = data;
...
static void
tablet_tool_receive_serial_id(void *data, struct zwp_tablet_tool1 *tool,
...
static void
tablet_tool_receive_hardware_id(void *data, struct zwp_tablet_tool1 *tool,
...
static void
tablet_tool_receive_capability(void *data, struct zwp_tablet_tool1 *tool,
                               uint32_t capability)
{
...
static void
tablet_tool_receive_done(void *data, struct zwp_tablet_tool1 *tool)
{
    LogMessageVerbSigSafe(X_NOTICE, -1, "xwayland: receiving tool DONE\n");
}

static void
tablet_tool_receive_removed(void *data, struct zwp_tablet_tool1 *tool)
{
    struct xwl_seat *xwl_seat = data;
    ...
    zwp_tablet_tool1_destroy(tool);

    LogMessageVerbSigSafe(X_NOTICE, -1, "xwayland: END receiving tool REMOVED\n");
}

static void
tablet_tool_proximity_in(void *data, struct zwp_tablet_tool1 *tool,
                         uint32_t serial, struct zwp_tablet1 *tablet,
    ...
    xorg_list_for_each_entry(xwl_tablet_tool, &xwl_seat->tablet_tools, link) {
        if (xwl_tablet_tool->tool == tool) {
            switch (xwl_tablet_tool->type) {
                case ZWP_TABLET_TOOL1_TYPE_ERASER:
                    xwl_tablet_tool->xdevice = xwl_tablet->eraser;
                    break;
                case ZWP_TABLET_TOOL1_TYPE_MOUSE:
                case ZWP_TABLET_TOOL1_TYPE_LENS:
...
static void
tablet_tool_proximity_out(void *data, struct zwp_tablet_tool1 *tool)
{
    struct xwl_seat *xwl_seat = data;
    struct xwl_tablet_tool *xwl_tablet_tool;
...
static void
tablet_tool_down(void *data, struct zwp_tablet_tool1 *tool, uint32_t serial)
{
    struct xwl_seat *xwl_seat = data;
    struct xwl_tablet_tool *xwl_tablet_tool;
    ValuatorMask mask;
...
static void
tablet_tool_up(void *data, struct zwp_tablet_tool1 *tool)
{
    struct xwl_seat *xwl_seat = data;
    struct xwl_tablet_tool *xwl_tablet_tool;
    ValuatorMask mask;
...
static void
tablet_tool_motion(void *data, struct zwp_tablet_tool1 *tool,
...
static void
tablet_tool_pressure(void *data, struct zwp_tablet_tool1 *tool,
...
static void
tablet_tool_distance(void *data, struct zwp_tablet_tool1 *tool,
...
static void
tablet_tool_tilt(void *data, struct zwp_tablet_tool1 *tool,
...
static void
tablet_tool_button_state(void *data, struct zwp_tablet_tool1 *tool,
...
static void
tablet_tool_frame(void *data, struct zwp_tablet_tool1 *tool, uint32_t time)
{
    struct xwl_seat *xwl_seat = data;
    struct xwl_tablet_tool *xwl_tablet_tool;
    ValuatorMask mask;
...
static void
tablet_seat_add_tablet(void *data, struct zwp_tablet_seat1 *tablet_seat, struct zwp_tablet1 *tablet)
{
    struct xwl_seat *xwl_seat = data;
    struct xwl_tablet *xwl_tablet;
    ...
    zwp_tablet1_add_listener(tablet, &tablet_listener, xwl_seat);

    LogMessageVerbSigSafe(X_NOTICE, -1, "xwayland: END adding tablet\n");
}

static void
tablet_seat_add_tool(void *data, struct zwp_tablet_seat1 *tablet_seat, struct zwp_tablet_tool1 *tool)
{
    struct xwl_seat *xwl_seat = data;
    struct xwl_tablet_tool *xwl_tablet_tool;
    ...
    zwp_tablet_tool1_add_listener(tool, &tablet_tool_listener, xwl_seat);
...
create_tablet_manager(struct xwl_screen *xwl_screen, uint32_t id, uint32_t version)
{
    ...
    LogMessageVerbSigSafe(X_NOTICE, -1, "xwayland: binding local tablet_manager object to server\n");
    xwl_screen->tablet_manager = wl_registry_bind(xwl_screen->registry,
                                                  id,
                                                  &zwp_tablet_manager1_interface,
                                                  min(version,1));

    // TODO: Have this actually do its work for all the seats :)
    ...
    xwl_seat->tablet_seat = zwp_tablet_manager1_get_tablet_seat(xwl_screen->tablet_manager, xwl_seat->seat);
    xorg_list_init(&xwl_seat->tablets);
    xorg_list_init(&xwl_seat->tablet_tools);

    zwp_tablet_seat1_add_listener(xwl_seat->tablet_seat, &tablet_seat_listener, xwl_seat);
              ...
              const char *interface, uint32_t version)
{
    ...
    LogMessageVerbSigSafe(X_NOTICE, -1, "xwayland: notified of interface %s (ver %d)\n", interface, version);
    ...
    if (strcmp(interface, "zwp_tablet_manager1") == 0 && version >= 1) {
